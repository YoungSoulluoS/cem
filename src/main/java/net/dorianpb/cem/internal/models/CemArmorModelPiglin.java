		...
		armorCandidates.forEach((armorPart, map) -> {
			if(armorCandidates.get(armorPart) != null){
				...
				Cuboid cuboid = switch(name){
					case EntityModelPartNames.HEAD -> new CemCuboid(reverse? -8 : 1, 0, 0, 8, 8, 8, 1.5f*extra, 1.5f*extra, 1.5f*extra, false, false, 64, 32, 32, 0);
					case EntityModelPartNames.HAT -> new CemCuboid(reverse? -8 : 1, 0, 0, 8, 8, 8, extra, extra, extra, false, false, 64, 32, 0, 0);
					case EntityModelPartNames.BODY -> new CemCuboid(reverse? -8 : 1, 0, 0, 8, 12, 4, extra, extra, extra, false, false, 64, 32, 16, 16);
