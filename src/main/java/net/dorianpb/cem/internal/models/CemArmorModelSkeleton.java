		...
		armorCandidates.forEach((armorPart, map) -> {
			if(armorCandidates.get(armorPart) != null){
				...
				Cuboid cuboid = switch(name){
					case EntityModelPartNames.HEAD -> new CemCuboid(reverse? -8 : 0, 0, 0, 8, 8, 8, 1.5f*extra, 1.5f*extra, 1.5f*extra, false, false, 64, 32, 32, 0);
					...
					case EntityModelPartNames.RIGHT_ARM -> new CemCuboid(reverse? -4 : -1, 0, -1, 4, 12, 4, extra, extra, extra, false, false, 64, 32, 40, 16);
					case EntityModelPartNames.LEFT_ARM -> new CemCuboid(reverse? -4 : -1, 0, -1, 4, 12, 4, extra, extra, extra, true, false, 64, 32, 40, 16);
					case EntityModelPartNames.RIGHT_LEG -> new CemCuboid(reverse? -4 : -1, 0, -1, 4, 12, 4, extra, extra, extra, false, false, 64, 32, 0, 16);
					case EntityModelPartNames.LEFT_LEG -> new CemCuboid(reverse? -4 : -1, 0, -1, 4, 12, 4, extra, extra, extra, true, false, 64, 32, 0, 16);
					default -> null;
				};
				
				var newarmor1 = new CemModelPart(64, 32, cuboid == null? Collections.emptyList() : Collections.singletonList(cuboid));
