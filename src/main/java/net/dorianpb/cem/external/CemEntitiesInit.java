...
public class CemEntitiesInit extends CemEntityInitializer{
	...
	public void onInit(){
		...
		// register(EntityType.PLAYER, CemPlayerRenderer::new);
		// register(EntityType.BOAT, CemBoatRenderer::new);
		// register(EntityType.BOAT, (ctx) -> new CemBoatRenderer(ctx, EntityType.BOAT));
		register(EntityType.ALLAY, CemAllayRenderer::new);
		register(EntityType.AXOLOTL, CemAxolotlRenderer::new);
		register(EntityType.FROG, CemFrogRenderer::new);
		register(EntityType.TADPOLE, CemTadpoleRenderer::new);
		...
		register(EntityType.WARDEN, CemWardenRenderer::new);
