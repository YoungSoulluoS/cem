...
public class CemPolarBearModel<T extends PolarBearEntity> extends PolarBearEntityModel<T> implements CemModel{
	...
	public CemPolarBearModel(CemModelRegistry registry){
