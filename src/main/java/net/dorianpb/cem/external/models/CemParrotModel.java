...
public class CemParrotModel extends ParrotEntityModel implements CemModel{
	...
	@Override
	public void setAngles(ParrotEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch){
